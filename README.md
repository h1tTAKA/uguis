...
bash ~/.claude/scripts/tts-toggle.sh re        # replay the latest answer
...
- **Replay**: `re` touches `~/.claude/.tts-replay`; the daemon consumes the
  one-shot flag and re-speaks the latest final/question (independent of state).
